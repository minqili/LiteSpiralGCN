...
from LSG.models.modules import conv_layer, mobile_unit, linear_layer, Reorg
import os
...
class DenseStack_Backnone(nn.Module):
    def __init__(self, input_channel=128, out_channel=24, latent_size=256, kpts_num=21, pretrain=True):
        ...
        if pretrain:
            ...
            weight = torch.load(os.path.join(cur_dir, 'E:\HandMesh-main\mobrecon\out\densestack.pth'))
...
if __name__ == '__main__':
    ...
    flops, params = profile(model, inputs=(torch.randn(3,3, 128, 128),))
